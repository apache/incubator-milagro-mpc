...
class TestS(unittest.TestCase):
    ...
    def test_1(self):
        ...
        for vector in self.tv:
            ...
            # ALPHA1 + BETA2 = K1 * W2
            ca11 = mpc.mta_client1(None, PUB1, vector['K1'], vector['R11'])
            cb12, beta2 = mpc.mta_server(None, PUB1, vector['W2'], ca11, vector['Z12'], vector['R12'])
            ...
            # ALPHA2 + BETA1 = K2 * W1
            ca22 = mpc.mta_client1(None, PUB2, vector['K2'], vector['R22'])
            cb21, beta1 = mpc.mta_server(None, PUB2, vector['W1'], ca22, vector['Z21'], vector['R21'])
