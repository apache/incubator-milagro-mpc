...
char* A1_hex = "52b7fe8435a2532b79ee252e5444c6a7178757f29a7ff17176ed9098ad168883";

char* B2_hex = "2f595fbef2fa542fd1d20d07f02c7d4c50b4abb2d1f76b4952219edf59f3ccf7";
...
char* A2_hex = "6f6aa64cdf2f28bb081ec019b3a8e2eed89052441626172daf106f523b0b44cc";

char* B1_hex = "0f757744e20d00dce6763b71ecb95f9fa9d4e788cfb9e39775d133e5e350ea93";
...
int main()
{
    ...
    rc = MPC_SUM_MTA(&A1, &B1, &ALPHA1, &BETA1, &SUM1);
    if (rc)
    {
    ...
    rc = MPC_SUM_MTA(&A2, &B2, &ALPHA2, &BETA2, &SUM2);
    if (rc)
    {
        fprintf(stderr, "FAILURE MPC_SUM_MTA rc: %d\n", rc);
        exit(EXIT_FAILURE);
