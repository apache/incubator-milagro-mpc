...
class Share:
    ...
    def __init__(self, p, q, a, b):
        ...
        self.p = p
        self.q = q
        self.n, self.g, self.lp, self.lq, self.mp, self.mq = paillier.keys(p,q)
        self.a = a
        self.b = b
        self.z = 0
        self.r = 0
    ...
    def client2(self, cb):
        ...
        # t = D_A(E_A(ab + z))
        t = paillier.decrypt(self.p, self.q, self.lp, self.lq, self.mp, self.mq, cb)
...
class Player:
    ...
    def __init__(self, name, p, q, sk=None, k=None, gamma=None):
        ...
        self.kgamma = Share(self.p, self.q, self.k, self.gamma)
        self.kw = Share(self.p, self.q, self.k, self.w)
