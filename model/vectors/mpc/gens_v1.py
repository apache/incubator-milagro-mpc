...
def genVector(test_no):
    ...
    vector['N1'] = hex(alice.n)[2:].zfill(512)
    vector['G1'] = hex(alice.g)[2:].zfill(512)
    vector['L1'] = hex(alice.l)[2:].zfill(512)
    vector['M1'] = hex(alice.m)[2:].zfill(512)        
    ...
    vector['N2'] = hex(bob.n)[2:].zfill(512)
    vector['G2'] = hex(bob.g)[2:].zfill(512)
    vector['L2'] = hex(bob.l)[2:].zfill(512)
    vector['M2'] = hex(bob.m)[2:].zfill(512)        
