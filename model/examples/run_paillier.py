...
if __name__ == "__main__":
    ...
    print("l {}".format(hex(l)[2:].zfill(256)))
    print("m {}".format(hex(m)[2:].zfill(256)))
    ...
    pt1 = paillier.decrypt(n, l, m, ct1)
    print("pt1 {}".format(hex(pt1)[2:].zfill(256)))    
    print("pt1 {}".format(pt1))
    
    # decrypt ciphertext 2
    pt2 = paillier.decrypt(n, l, m, ct2)
    print("pt2 {}".format(hex(pt2)[2:].zfill(256)))
    ...
    pt3 = paillier.decrypt(n, l, m, ct3)
    ...
    pt4 = paillier.decrypt(n, l, m, ct4)
