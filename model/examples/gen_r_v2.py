...
if __name__ == "__main__":
    ...
    with open("R.txt", "w") as f:
        ...
        f.write(f"char* R11_hex = \"{hex(r1)[2:].zfill(1024)}\";\n\n")
        f.write(f"char* CB12_hex = \"{hex(cb)[2:].zfill(1024)}\";\n\n")
        f.write(f"char* R12_hex = \"{hex(r2)[2:].zfill(1024)}\";\n\n")
    ...
    with open("R.txt", "a") as f:
        ...
        f.write(f"char* R22_hex = \"{hex(r2)[2:].zfill(1024)}\";\n\n")
        f.write(f"char* CB21_hex = \"{hex(cb)[2:].zfill(1024)}\";\n\n")
        f.write(f"char* R21_hex = \"{hex(r1)[2:].zfill(1024)}\";\n\n")
    ...
    print(f"kgamma expected {hex(expected)}")
    print(f"kgamma {hex(kgamma)}")
    ...
    with open("R.txt", "a") as f:
        ...
        f.write(f"char* KGAMMA_hex = \"{hex(kgamma)[2:].zfill(64)}\";\n\n")
    ...
    print(f"alice.Gamma {alice.Gamma}")
    print(f"bob.Gamma {bob.Gamma}")
    ...
    print(f"alice.Gamma + bob.Gamma {SUMGAMMAPT}")
    ...
    with open("R.txt", "a") as f:
        ...
        f.write(f"char* GAMMAPT2_hex = \"{bobGamma}\";\n\n")
        f.write(f"char* SUMGAMMAPT_hex = \"{SUMGAMMAPT}\";\n\n")
