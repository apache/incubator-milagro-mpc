...
if __name__ == "__main__":
    ...
    with open("S.txt", "w") as f:
        ...
        f.write(f"char* ALPHA1_hex = \"{hex(alice.kw.alpha)[2:].zfill(64)}\";\n\n")
    ...
    with open("S.txt", "a") as f:
        ...
        f.write(f"char* BETA1_hex = \"{hex(alice.kw.beta)[2:].zfill(64)}\";\n\n")
        f.write(f"char* ALPHA2_hex = \"{hex(bob.kw.alpha)[2:].zfill(64)}\";\n\n")
    ...
    with open("S.txt", "a") as f:
        ...
        f.write(f"char* SIG_S1_hex = \"{hex(alice.s(m,r))[2:].zfill(64)}\";\n\n")
